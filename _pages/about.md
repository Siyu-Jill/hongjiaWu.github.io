...
# 🔥 News
- *2025.12*: &nbsp;🎉🎉 One first-author paper has been submitted to IEEE Communications Magazine (under major revision).
- *2025.10*: &nbsp;🎉🎉 One first-author paper has been accepted by IEEE Transactions on Mobile Computing (TMC).
- *2025.09*: &nbsp;🎉🎉 One first-author paper has been accepted by IEEE Transactions on Services Computing (TSC).


# 📝 Selected First-Author Publications
- <span style="background-color: #33cccc; color: white; padding: 1px 4px; font-size: 12px;">``TMC 2025``</span> **Hongjia Wu**, M Xu, Z Xiong, L Gao, H Pan, D Niyato, TT Chan, “[A QoE-driven personalized incentive mechanism design for AIGC services in resource-constrained edge networks](https://ieeexplore.ieee.org/abstract/document/11217235),” IEEE Transactions on Mobile Computing, Early Access, Oct. 2025. (**CCF A**, **SCI Q1**)
...
#### Journal Papers:
- <span style="background-color: #33cccc; color: white; padding: 1px 4px; font-size: 12px;"></span> Haimiao Mo, **Hongjia Wu**, Qian Rong, Zhijian Hu, Meng Yi, Peipei Chen, “[An anxiety screening framework integrating multimodal data and graph node correlation](https://www.sciencedirect.com/science/article/pii/S0933365725001241),” Artificial Intelligence in Medicine, vol.167, pp. 103189, Sep. 2025. (**SCI Q1**)
- <span style="background-color: #33cccc; color: white; padding: 1px 4px; font-size: 12px;"></span> Haimiao Mo, Juan Liang, Bing Li, Zhijian Hu, Meng Yi, **Hongjia Wu**, Qian Rong, Zeyuan Xu, “[A Non-Invasive Framework for Heart Function Assessment by Multi-Task Learning](https://ieeexplore.ieee.org/abstract/document/10937937),” IEEE Transactions on Instrumentation and Measurement, vol. 74, pp. 1-13, Mar. 2025. (**SCI Q1**)

#### Conference Papers:
- <span style="background-color: #cc6666; color: white; padding: 1px 4px; font-size: 12px;">``INFOCOM 2025``</span> X. Zhuang, J. Wu, **Hongjia Wu**, T. Zhang, and L. Gao, “Joint optimization of model inferencing and task offloading for MEC-empowered large vision model services,” in Proc. IEEE Int. Conf. Comput. Commun. (INFOCOM), London, United Kingdom, May 2025, pp. 1-10. (**CCF A**)
- <span style="background-color: #99cc33; color: white; padding: 1px 4px; font-size: 12px;">``ICC 2025``</span> X. Zhuang, J. Wu, **Hongjia Wu**, M. Tang, and L. Gao, “QoS-driven hybrid inference scheme for generative diffusion models in MEC-enabled AI-generated content networks,” in Proc. IEEE Int. Conf. Commun. (ICC), Montreal, QC, Canada, Jun. 2025, pp. 1151-1156. (CCF C)
